...
var playSound;
    var player_sprite_sheet_src = 'imgs/rahim_running_sprite.png';
    var birthday_boy = false;
...
var assetLoader = (function() {
  ...
  this.imgs        = {
    ...
    'avatar_normal' : 'imgs/rahim_running_sprite.png',
...
var player = (function(player) {
  ...
  // spritesheets
  player.sheet     = new SpriteSheet(player_sprite_sheet_src, player.width, player.height);
 ...
 */
    ...
    var player_name = prompt("Please enter your name","Raahim");
    if (player_name == null || player_name== "")
	player_name = "Raahim";
    if (!(player_name == "Raahim" || player_name == "Rahim" || player_name == "rahim" || player_name == "raahim"))
	if (player_name == "fam" || player_name == "family")
	    player_sprite_sheet_src="imgs/bikesprite.png";
    else
	player_sprite_sheet_src="imgs/basic_running_sprite.png";
    else
	birthday_boy = true;
...
function gameOver() {
  stop = true;
    $('#score').html(score);
    if (birthday_boy)
	window.alert("Happy Birthday Raahim!!!!!");
  $('#game-over').show();
