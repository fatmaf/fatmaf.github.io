//from https://blog.sklambert.com/html5-game-tutorial-module-pattern/
(function () {
  // define variables
...
var assetLoader = (function() {
  ...
  this.imgs        = {
    ...
    "avatar_normal" : "imgs/r1sprite.png"
  };
...
function startGame() {
  ...
  player.height = 178;
  player.speed  = 6;
  player.sheet  = new SpriteSheet("imgs/r1sprite.png", player.width, player.height);
